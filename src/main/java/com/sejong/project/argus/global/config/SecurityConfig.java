...
import com.sejong.project.argus.global.filter.AuthenticationTokenFilter;
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http
                .authorizeHttpRequests((authorize) -> authorize
                        ...
                        .requestMatchers("/v3/api-docs/**", "/swagger-ui/**", "/swagger-resources/**","/fcm/startFcm").permitAll()
